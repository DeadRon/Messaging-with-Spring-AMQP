...
public class RabbitMQConfig {
    ...
    //Instância uma fila para o Contêiner do Spring
    @Bean
    public Queue queueCashback(){
        return new Queue("orders.v1.order-created.generate-cashback"); //nome da fila. Vai avisar toda vez que uma venda ser criada
    }
